      ...
      <div className="relative mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white bg-clip-text">
            Добро пожаловать в{' '}
            <span>
              {loading ? 'Loading...' : siteInfo?.siteName || 'DotStore'}
            </span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-gray-300 max-w-3xl mx-auto">
            {loading ? 'Loading...' : siteInfo?.siteDescription || 
              'Широкий выбор электроники и аксессуаров по лучшим ценам с доставкой по всей России'}
          </p>
